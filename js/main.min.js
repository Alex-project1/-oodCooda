  ...
  const j = {
      ...
      loop: {
        loopCreate: function (e) {
          ...
          f(s, `.${t.slideClass}, swiper-slide`).forEach((e, t) => {
  ...
  const le = [
    ...
    function (e) {
      ...
      s({
        ...
        i("init", () => {
          !1 === t.params.scrollbar.enabled ? L() : (M(), w(), f());
        }),
    ...
    function (e) {
      ...
      function L(e) {
        ...
        let i, r, l, o, d, p, u, g, w, b, E, x, S, T, M, C, L, P;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
    ...
    function (e) {
      ...
      function h(e) {
        ...
        (t.pagination &&
          ...
          t.pagination &&
            a.matches(Z(t.params.pagination.bulletClass)) &&
            a.click());
      }
      function f() {
        return (
              ...
              f() &&
                t.pagination.bullets.forEach((s) => {
                  t.params.pagination.clickable &&
                    ...
                    s.matches(Z(t.params.pagination.bulletActiveClass))
          ...
          c.shadow &&
            (p
              ? ((m = t.wrapperEl.querySelector(".swiper-cube-shadow")),
                m ||
                  ((m = g("div", "swiper-cube-shadow")), t.wrapperEl.append(m)),
                (m.style.height = r + "px"))
      ...
      const i = (e, s) => {
        let a = t.isHorizontal()
          ...
          i = t.isHorizontal()
            ? e.querySelector(".swiper-slide-shadow-right")
            : e.querySelector(".swiper-slide-shadow-bottom");
        a || (a = ne("flip", e, t.isHorizontal() ? "left" : "top")),
          i || (i = ne("flip", e, t.isHorizontal() ? "right" : "bottom")),
      ...
      ae({
        ...
        setTransition: (e) => {
          ...
          s.forEach((t) => {
            ...
            re({ swiper: t, duration: e, transformElements: s });
        },
        recreateShadows: () => {
          t.params.flipEffect,
            t.slides.forEach((e) => {
          ...
          setTranslate: () => {
            ...
            for (let e = 0, t = a.length; e < t; e += 1) {
              ...
              if (
                ...
                e || (e = ne("coverflow", t, n ? "left" : "top")),
                  s || (s = ne("coverflow", t, n ? "right" : "bottom")),
      ...
      ae({
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((h && f.shadow) || !h) {
              ...
              if ((!e && f.shadow && (e = ne("creative", a)), e)) {
        ...
        setTransition: (e) => {
          ...
          s.forEach((t) => {
            ...
            re({ swiper: t, duration: e, transformElements: s, allSlides: !0 });
        },
...
function btnFunc(e) {
  if (e.target.classList.contains("tabs__nav-btn")) {
    document.querySelectorAll(".tabs__nav-btn").forEach((e) => {
      e.classList.remove("cood-cooda");
    }),
      e.target.classList.add("cood-cooda");
  }
}
document.body.addEventListener("click", btnFunc),
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelector(".header__burger"),
      t = document.querySelector(".header .header__menu"),
      s = document.querySelector("body");
    e.addEventListener("click", function () {
      t.classList.toggle("active"),
        s.classList.toggle("overflow"),
...
const swiper = new Swiper(".mySwiper", {
    ...
    breakpoints: {
      320: { slidesPerView: 1, effect: "swiper", centeredSlides: !1 },
      991: { slidesPerView: 3 },
    },
  }),
  cafeBtn = document.querySelector(".family__btn"),
  coodRoom = document.querySelector(".coodRoom");
cafeBtn.addEventListener("click", () => {
  coodRoom.classList.add("show");
}),
  coodRoom.addEventListener("click", () => {
    coodRoom.classList.remove("show");
  });
const bLink = document.querySelector(".birth__purchase");
...
const buyCoodLink = document.querySelector('#buyCoodLink');
const galleryLink = document.querySelector('#galleryLink');
const teamLink = document.querySelector('#teamLink');

const links = [roadMapLink, buyCoodLink, galleryLink, teamLink]
